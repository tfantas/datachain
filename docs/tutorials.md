...
* Multimodal: [GitHub](https://github.com/datachain-ai/datachain-examples/blob/main/multimodal/clip_fine_tuning.ipynb) or [Google Colab](https://colab.research.google.com/github/datachain-ai/datachain-examples/blob/main/multimodal/clip_fine_tuning.ipynb)
